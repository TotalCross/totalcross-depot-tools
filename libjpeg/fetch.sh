...
elif [ -n "${LIBJPEG_GITHUB_TOKEN:-}" ]; then
  github_token="${LIBJPEG_GITHUB_TOKEN}"
...
download_release_asset() {
  ...
  echo "Downloading libjpeg artifact ${candidate} from ${github_repo}@${release_tag}"
  ...
  echo "Direct libjpeg artifact download failed; trying GitHub release asset API"
