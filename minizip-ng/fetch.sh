...
elif [ -n "${MINIZIP_NG_GITHUB_TOKEN:-}" ]; then
  github_token="${MINIZIP_NG_GITHUB_TOKEN}"
...
download_release_asset() {
  ...
  echo "Downloading minizip-ng artifact ${candidate} from ${github_repo}@${release_tag}"
  ...
  echo "Direct minizip-ng artifact download failed; trying GitHub release asset API"
