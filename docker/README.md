...
workflows. Version `v2.0.2` is the minimal native-CMake generation: Ubuntu
...
Fontconfig development headers, and the AArch64 cross compiler. The ARMv7
compatibility image also includes Python and Fontconfig headers for Skia. GN is
