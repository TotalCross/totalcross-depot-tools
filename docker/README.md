...
workflows. Version `v2.0.3` is the minimal native-CMake generation: Ubuntu
...
Fontconfig and EGL development headers, and the AArch64 cross compiler. The ARMv7
compatibility image also includes Python, Fontconfig, and EGL headers for Skia. GN is
