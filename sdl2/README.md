...
This directory will wrap sdl2 at https://github.com/libsdl-org/SDL.git, revision release-2.32.8.
...
local/<platform>/<arch>, include cmake/AutoFetchSDL2.cmake, call
tcvm_auto_fetch_sdl2, find_package(SDL2 REQUIRED), and link
SDL2::SDL2.
