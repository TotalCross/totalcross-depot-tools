...
artifact_dir="${build_dir}/artifact/qrcodegen/${platform_arch}"
...
name=qrcodegen
upstream_commit=2c9044de6b049ca25cb3cd1649ed7e27aa055138
distribution_version=${version}
platform_arch=${platform_arch}
EOF
tar -C "${build_dir}/artifact" -czf "${build_dir}/qrcodegen-${artifact_name_platform}.tar.gz" qrcodegen
echo "${build_dir}/qrcodegen-${artifact_name_platform}.tar.gz"
