...
- [x] (2026-07-18 00:56Z) Added the executable `scripts/build-cmake-multi.sh` command-line equivalent of the shared native build action, including the paired Docker validation and optional test execution for local reproduction.
- [x] (2026-07-18 01:06Z) Added executable zlib target wrappers for Android, Apple, Linux, macOS, and Windows. Each delegates configure/build/install/package execution to `scripts/build-cmake-multi.sh`; the macOS arm64 wrapper completed a local package validation.
